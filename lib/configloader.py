...
CONFIG_COMMENT = "#"
CONFIG_LOAD = "El archivo de configuraciones '{0}' ha sido cargado."
...
CONFIG_SAVED = "El archivo de configuraciones '{0}' ha sido guardado."
CONFIG_SEPARATOR = " = "
FALSE = "FALSE"
TRUE = "TRUE"
...
class ConfigLoader(object):
    ...
    def __init__(self, directory, conffile, **kwargs):
        ...
        Keywords:
            - verbose (bool) = Indica si se imprime el estado de ejecución o no
              en consola
    ...
    def is_false(self, param):
        ...
        if param in self.get_parameters():
            if self.configs[param].upper() == FALSE or self.configs[param] \
                    == "0":
                return True
            else:
                return False
    ...
    def is_true(self, param):
        ...
        """
        if param in self.get_parameters():
            if self.configs[param].upper() == TRUE or self.configs[param] == \
                    "1":
                return True
            else:
                return False
    ...
    def get_value(self, param, **kwargs):
        ...
        if str(param).isdigit():
            ...
            if 0 <= param < len(self.config_single):
                ...
                if kwarg_is_true_param(kwargs, "autoNumberify"):
            ...
            if self.totalconfigs > 0:
                for parameter in self.get_parameters():
                    try:
                        ...
                        errors.throw(errors.ERROR_CONFIGCORRUPT,
                                     self.filename_title)
