% Template:     Template-FI3104/Reporte LaTeX
% Versión:      1.1 (15/09/2016)
% Codificación: UTF-8
%
...
\newcommand{\codigodelcurso}{FI-3104}

\newcommand{\nombreuniversidad}{Universidad de Chile}
\newcommand{\nombrefacultad}{Facultad de Ciencias Físicas y Matemáticas}
\newcommand{\departamentouniversidad}{Departamento de Física}
\newcommand{\imagendeldepartamento}{images/dfi}
...
\section{Pregunta 1}
	...
	\subsection{Introducción}
		...
		Se busca integrar la siguiente ecuación diferencial:
		
		\insertequation[\label{ecuacion1}]{\bigg( \fracnderivat{}{r}{2} - \frac{2}{\pow{r}{2}}\bigg)\Phi(r) = -8 \pi r \pow{e}{-\pow{r}{2}}}
		
		Para $1 < r < \infty$, cumpliendo las condiciones de borde $\Phi(1)=1$ y $\Phi(\infty)=0$.

		\newp Acá introduzco el problema a resolver, parámetros como las condiciones de borde, etc. Recuerden incluir toda la información necesaria para que alguien pueda reproducir su programa/resultados leyendo su informe - pero sean concisos, lo mejor es una explicación corta y clara.
		
	
	\subsection{Procedimiento}
	
		¿Cómo resolver el problema que planteamos recién? con algún algoritmo o método de resolución numérica. El método de ...., en este caso utilizamos...., etc, etc, por medio de la expresión
		
		\insertequation[\label{ecuacion2}]{ \Phi(r) = \bar{\Phi}(r) + \frac{\lpow{\Phi}{b} - \bar{\Phi}(b)}{\lpow{\Phi}{h}(b)}\lpow{\Phi}{h}(r)}
		
		Explicaciones cortas y claras. Aquí expliquen qué hicieron y con qué parámetros (por ejemplo, su valor de h o $\epsilon$).
		
	
	\subsection{Resultados}
	
		Aquí van los resultados de su tarea. Apóyense en tablas y gráficos, como muestra la Figura 1.
		
		\insertimage[\label{imagen1}]{ejemplo.png}{scale=0.6}{Un ejemplo de gráfico.}
		
	
	\subsection{Conclusiones}
	
		Análisis y conclusiones a partir de los resultados obtenidos. Cuiden que sus informes sean ordenados y coherentes, pueden agregar subsecciones donde lo consideren necesario.
		
		\begin{longtable}{ccc}
			\caption{Ejemplo de tabla.}\label{foo}\\
			\hline
